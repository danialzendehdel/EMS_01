...
def globale_fine_ottimizzazione(dati_modello, individuo, setup):
# def globale_fine_ottimizzazione(individuo, dati_modello, setup):
    ...
    # nell'online, i dati vanno salvati tra una chiamata e l'altra della funzione
    dati_MG_online=dati_modello[1]
    ...
    for timeslot in range(len(dataset[0])):
        ...
        if setup=='online':
            dati_MG_online[0].SoC_autoconsumo = SoC_MG_1
            dati_MG_online[1].SoC_autoconsumo  = SoC_MG_2
            dati_MG_online[2].SoC_autoconsumo  = SoC_MG_3
            dati_MG_online[3].SoC_autoconsumo  = SoC_MG_4
            dati_MG_online[4].SoC_autoconsumo  = SoC_MG_5
            dati_MG_online[5].SoC_autoconsumo  = SoC_MG_6
            dati_MG_online[6].SoC_autoconsumo  = SoC_MG_7   
        ...
        if setup=='online':
            dati_MG_online[0].SoC= SoC_MG_1
            dati_MG_online[1].SoC  = SoC_MG_2
            dati_MG_online[2].SoC = SoC_MG_3
            dati_MG_online[3].SoC  = SoC_MG_4
            dati_MG_online[4].SoC  = SoC_MG_5
            dati_MG_online[5].SoC  = SoC_MG_6
            dati_MG_online[6].SoC  = SoC_MG_7 
    ...
    # azzeramento della Soc alla fine della simulazione solo se rolling-time horizon
    if setup=="rolling":       
        dati_MG[0].SoC = dati_MG[0].SoC_0
        dati_MG[1].SoC = dati_MG[1].SoC_0
        dati_MG[2].SoC = dati_MG[2].SoC_0
    ...
    risultati_finali=[somma_FO_globale_energy_community,
                      ...
                      conseguenti,
                      pesi_regole,
                      somma_FO_autoconsumo_energy_community,
                      vettore_FO
                      ]
