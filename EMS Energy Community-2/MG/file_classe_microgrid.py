...
class MG:
    ...
    def simula_microgrid(self,
        ...
        if autoconsumo=='no':
            ...
            costo_investimento=0.047*P_G_predetta*delta_t
            costo_fisso_bolletta=0.0029
        ...
        if autoconsumo=='yes':
            ...
            # costo_investimento=0 # punto di vista del prosumer
            IVA=0.1
            costo_decisione=-ricavo+costo_investimento+C_b_k+(costo_acquisto+costo_fisso_bolletta)*(1+IVA)
